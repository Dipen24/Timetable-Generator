...
public class StudentDialog extends JDialog {
    ...
    public StudentDialog(JFrame parent, String title, String[] existingData) {
    ...
    private boolean validateInput() {
        ...
        // Check if username already exists (only for new students)
        if (getTitle().equals("Add Student") &&
                UserAuthenticator.userExists("student", usernameField.getText())) {
            JOptionPane.showMessageDialog(this,
